...
class ParagraphFormat (  WordAttrCollection) :
    ...
    def SetFirstLineIndentChars(self, value:float):
        """
        Sets the value that represents the first line indent chars for paragraph.
        """
        GetDllLibDoc().ParagraphFormat_SetFirstLineIndentChars.argtypes=[c_void_p ,c_float]
        CallCFunction(GetDllLibDoc().ParagraphFormat_SetFirstLineIndentChars,self.Ptr, value)
