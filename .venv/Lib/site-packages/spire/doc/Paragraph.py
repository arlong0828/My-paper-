...
#
    ...
    def AppendChart(self ,cType:ChartType, width:float,height:float)->ShapeObject:
        """
        <summary>
            Append an chart object into the document and scales it to the specified size.
        </summary>
        """
        enumchartType:c_int = cType.value

        GetDllLibDoc().Paragraph_AppendChart.argtypes=[c_void_p ,c_int,c_float,c_float]
        GetDllLibDoc().Paragraph_AppendChart.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Paragraph_AppendChart,self.Ptr, enumchartType,width,height)
        ret = None if intPtr==None else ShapeObject(intPtr)
        return ret

    @dispatch

    def AppendChart(self ,chartType:ChartType, horzPos:HorizontalOrigin, left:float,vertPos:VerticalOrigin,top:float,width:float,height:float,wrapType:TextWrappingStyle)->ShapeObject:
        """
        <summary>
            Append an chart object into the document and scales it to the specified size.
        </summary>
        ...
        GetDllLibDoc().Paragraph_AppendChartCHLVTWHW.argtypes=[c_void_p ,c_int,c_int,c_float,c_int,c_float,c_float,c_float,c_int]
        GetDllLibDoc().Paragraph_AppendChartCHLVTWHW.restype=c_void_p
        intPtr = CallCFunction(GetDllLibDoc().Paragraph_AppendChartCHLVTWHW,self.Ptr, enumchartType,enumhorzPos,left,enumvertPos,top,width,height,enumwrapType)
        ret = None if intPtr==None else ShapeObject(intPtr)
        return ret
