...
class nsgaAlgo(object):
    ...
    def load_instance(self):
        ...
        # D = 0
        # R = 0
        # for i in range(len(self.json_instance)):
        #     D += self.json_instance[i][5]
        #     R += self.json_instance[i][6]
        # print(self.day , "&"  , 3 , "&" , 100 , "&" , D , "&" ,  R)
    ...
    def result(self):
        ...
        #     print(i)
        satellite_cost1 = best_all_morning_customer_id_and_fitness1[0][1][1] + best_all_afternoon_customer_id_and_fitness1[0][1][1]
        satellite_cost2 = best_all_morning_customer_id_and_fitness2[0][1][1] + best_all_afternoon_customer_id_and_fitness2[0][1][1]
        self.satellite_cost.append(satellite_cost1)
        self.satellite_cost.append(satellite_cost2)
        # print("衛星1的最短路徑：")
        # print("上午：")
    ...
    def First_route(self):
        ...
        print("self.depot , self.number_satellite , self.centers , self.satellite_cost , self.fe_vehicle_capacity" , self.depot , self.number_satellite , self.centers , self.satellite_cost , self.fe_vehicle_capacity)
        gurobi_Model.main(self.depot , self.number_satellite , self.centers , self.satellite_cost , self.fe_vehicle_capacity)
        # pass
